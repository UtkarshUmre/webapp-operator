...
// +kubebuilder:rbac:groups=webapp.webapp-operator.io,resources=webapps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.webapp-operator.io,resources=webapps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=webapp.webapp-operator.io,resources=webapps/finalizers,verbs=update
